...
const projectList = [
    {
        ...
        "description2": "The application utilized Flutter as the frontend framework to allow cross-platform framework data synchronization for UI rendering for both Android and iOS, and FireStore as backend to store multi-user authentication as well as respective user progression exercise data. We had three weekly Scrum Meetings and integrated Miro as an extensive Scrum board for release plans, sprint plans, sprint retrospectives, etc.",
        "logo": fitRecurLogo,
        "image1": fitRecurHome,
    ...
    },
    {
        ...
        "description1": "ChefQuest is a gamified cooking app designed to make cooking feel less intimidating and fun for people who don't cook regularly but want to learn how to cook at home during the COVID-19 Pandemic. The motivation for developing this app was to help people that are in need of help during the COVID-19 lockdown, where ordering delivery food all the time may become financially overwhelming, and home cooking may become essential. ",
